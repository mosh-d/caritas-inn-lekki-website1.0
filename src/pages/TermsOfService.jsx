          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              ...
              <li>
                ...
                links to third-party websites. Caritas Inn Lekki is not
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              <li>
                ...
                of Caritas Inn Lekki or its licensors and is protected by
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              <li>
                ...
                your own risk. Caritas Inn Lekki does not warrant that the
                website will be error-free or that access will be
                uninterrupted. The information provided is on an "as-is"
                basis.
              </li>
              <li>
                <strong>Limitation of Liability:</strong> Caritas Inn Lekki shall
